...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_RAISE] = LAYOUT(
        ...
        _______,          KC_MPLY, KC_MPRV,  KC_MNXT, _______, _______, _______, _______, _______, KC_MS_BTN1, KC_MS_BTN2,_______, _______, \
        _______,  _______, _______,                            KC_R,                         _______, _______, _______, _______, _______
    ),
    ...
    [_ADJUST] = LAYOUT(
        ...
        XXXXXXX,          XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_QWERTY, KC_COLEMAK, XXXXXXX, XXXXXXX, XXXXXXX, \
