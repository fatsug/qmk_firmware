...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_60_ansi(
    ...
    KC_LCTL,  KC_LGUI, KC_LALT,                        KC_SPC,                                   MO(_FN1), MO(_RAISE), MO(_FN1), KC_RCTL
  ),

  [_COLEMAK] = LAYOUT_60_ansi(
    KC_GESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,   KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,   KC_BSPC, \
    KC_TAB,   KC_Q,    KC_W,    KC_F,    KC_P,    KC_G,    KC_J,   KC_L,    KC_U,    KC_Y,    KC_SCLN, KC_LBRC, KC_RBRC,  KC_BSLS, \
    MO(_FN1), KC_A,    KC_R,    KC_S,    KC_T,    KC_D,    KC_H,   KC_N,    KC_E,    KC_I,    KC_O,    KC_QUOT,           KC_ENT,  \
  ...
  [_FN1] = LAYOUT_60_ansi(
    ...
    KC_CAPS, RGB_MOD, KC_UP,   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
  ...
  [_RAISE] = LAYOUT_60_ansi(
    ...
    _______, KC_MPLY, KC_MPRV, KC_MNXT, _______, _______, _______, _______, _______, KC_QWERTY, KC_COLEMAK,              _______, \
    _______,  _______, _______,                            _______,                            _______, _______, _______, _______
  )
};
