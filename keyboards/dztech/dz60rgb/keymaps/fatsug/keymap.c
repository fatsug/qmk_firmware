...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_BASE] = LAYOUT(
        ...
        KC_LSFT,          KC_Z,    KC_X,     KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT, RSFT_T(KC_SLSH), KC_UP, LT(_NAVI,KC_DEL), \
    ...
    [_RAISE] = LAYOUT(
        ...
        KC_RCTRL, _______, _______,                            KC_R,                           _______, _______, KC_MPRV, KC_VOLD, KC_MNXT
    ),
    ...
    [_NAVI] = LAYOUT(
        ...
        XXXXXXX,          XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,      XXXXXXX, KC_PGUP, XXXXXXX, \
        _______,  _______, _______,                            KC_N,                        KC_ABHOM, KC_ABEND, KC_LSTRT, KC_PGDN, KC_LEND
    )
